            ...
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500">
                  Stay updated with the latest insights and features from
                  Echo-UI. Subscribe to our newsletter and never miss an update!
                </p>
              </div>
            </div>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; {new Date().getFullYear()} Echo Vision. All rights
              reserved.
            </p>
